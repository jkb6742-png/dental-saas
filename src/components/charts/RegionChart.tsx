...
export default function RegionChart({ data }: { data: DataPoint[] }) {
  return (
    <ResponsiveContainer width="100%" height={260}>
      <BarChart data={data} layout="vertical" margin={{ top: 4, right: 8, left: 0, bottom: 0 }}>
        ...
        <YAxis type="category" dataKey="name" tick={{ fontSize: 11, fill: "#4e5968" }} axisLine={false} tickLine={false} width={110} />
        ...
        <Bar dataKey="신환" fill="#05c072" radius={[0, 4, 4, 0]} maxBarSize={18} stackId="a" />
        <Bar dataKey="구환" fill="#ebf3fe" radius={[0, 4, 4, 0]} maxBarSize={18} stackId="a" />
      </BarChart>
    </ResponsiveContainer>
  )
}
